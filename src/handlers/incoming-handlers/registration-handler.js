...
const { serviceMessageTexts, registrationMessages, validationMessageTexts, validConfirmationAnswers } = JSON.parse(fs.readFileSync(path.resolve("config.json"), "utf-8"));
